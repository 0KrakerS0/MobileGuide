...
public class MenuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private MenuItemViewHolder prepareMenuItemViewHolder(ViewGroup parent) {
        ...
        holder.itemView.setOnClickListener(v -> onMenuItemClick.onMenuItemClick(menuItemViews.get(getFixedAdapterPosition(holder)), userView));
        return holder;
    }
    ...
    public interface OnMenuItemClick {
        ...
        OnMenuItemClick NULL = (menuItemView, userView) -> {/*Nic nie robi*/};

        void onMenuItemClick(MenuItemView menuItemView, UserView userView);
    }
}
